/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 54bd460b7d8e5a36445f504c448eb036)
// Runtime types generated with workerd@1.20260114.0 2024-11-28 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		PUBLIC_DISPLAY_PLAY_URL: string;
		PUBLIC_PLAY_URL: string;
		PUBLIC_BACKEND_URL: string;
		PUBLIC_WS_URL: string;
		PUBLIC_CORKBOARD_URL: string;
		AUTH_SECRET: string;
		WALLO_CLIENT_ID: string;
		WALLO_CLIENT_SECRET: string;
